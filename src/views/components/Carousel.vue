<template>
  <section class="section section-hero section-lg section-shaped overflow-hidden my-0 pt-6">
      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-lg-6 mb-lg-auto">
          ...
          <b-carousel id="carousel-1"
            ...
            <b-carousel-slide
              img-src="img/theme/clean1.jpg"
            ></b-carousel-slide>
            <b-carousel-slide
              img-src="img/theme/clean2.jpg"
            ></b-carousel-slide>
            <b-carousel-slide
              img-src="img/theme/clean3.jpg"
            ></b-carousel-slide>
          </b-carousel>
          </div>
        </div>

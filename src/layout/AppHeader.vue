<template>
  <header class="header-global" v-on:scroll="onScroll" :class="{'scrolling' : scroll}">
    <base-nav class="navbar-main" type effect="light" expand>
      <div slot="brand" class="navbar-brand mr-lg-5" v-scroll-to="'#hero'">
        <img src="img/clean_company.jpg" alt="logo" />
      </div>
      ...
      <ul class="navbar-nav align-items-lg-center ml-lg-auto">
        <li class="nav-item">
          <button class="nav-link nav-link-icon custom-link" v-scroll-to="'#carousel'">
            Галерея
          </button>
        </li>
        <li>2</li>
